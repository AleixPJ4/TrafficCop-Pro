...
function scShowView(name){
  ...
  const map={dashboard:"#scDashboard",forms:"#scFormsView",library:"#scLibraryView",guide:"#scGuideView",review:"#scReviewView"};
...
function init(){setupCatalog();setupDrawer();setupDrawerBehaviourFix();setupDesktopMenuFix();setupAI();setupDocuments();setupSuite();setupNav();setupTicket();setupAtestados();setupAtestadosManager();setupAtestadosPolish();setupFullscreenAndButtons();setupSeguridadCiudadana();setupDesktopRail();console.log('TrafficCop Pro 3.6.0 iniciado correctamente')}
