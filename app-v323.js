...
function init(){setupCatalog();setupDrawer();setupDrawerBehaviourFix();setupAI();setupDocuments();setupSuite();setupNav();setupTicket();setupDesktopRail();console.log('TrafficCop Pro 3.2.3 iniciado correctamente')}
